...
const styles = StyleSheet.create({
  ...
  savePresetLink: { color: '#0E7C7B', fontSize: 13, fontWeight: '700', marginTop: 4 },
  ...
  roleChipText: { color: '#888', fontSize: 14, fontWeight: '700' },
  ...
  modalCancel: { color: '#7A8899', fontSize: 15, fontWeight: '700' },
